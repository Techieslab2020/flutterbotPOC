                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        ...
                        new Container(
                        margin: const EdgeInsets.only(top: 5.0),
                        child:widget.item.offerprice=="0"? new Text("MRP: "+widget.item.actualprice):new Text("MRP: "+widget.item.actualprice,style: TextStyle(decoration: TextDecoration.lineThrough)),
                      ),
                       Visibility(
                        child:new Container(
                        margin: const EdgeInsets.only(top: 5.0),
                        child: new Text("Offer Price: "+widget.item.offerprice),
                      ),
                        maintainSize: true, 
                        maintainAnimation: true,
                        maintainState: true,
                        visible:widget.item.offerprice=="0"? false:true 
                      ),
...
class _CarouselSelectWidget extends State<CarouselSelectWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    RaisedButton(child: Text("load more"/*widget.carouselSelect.loadmore*/),onPressed: null)
        ],
      ),
    );
